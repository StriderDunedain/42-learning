...
### Instructions
Import from `ft_printf.h` a function of the same name and just use it like a normal `printf`

### Resources
Mostly my brain, AI for bugs, ideas and manual stuff (ofc I've learnt a lot and not just copy-pasted) and a geekbrains article about variadic arguments